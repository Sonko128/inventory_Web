         ...
         <div className="bg-purple-300 md:flex shadow-md w-full">
          <ul className="flex items-center ml-5">
            ...
            <div className="bg-red-300 h-[20vh] rounded-md p-4">
              <h1>TOTAL AMOUNT IN YOUR STORE</h1>
              <p>2000000 Ugshillings</p>
            </div>
            <div className="bg-green-300 h-[20vh] rounded-md p-4">
              <h1>TOTAL CATEGORY</h1>
              <p>6 Categries</p>
            </div>
            <div className="bg-purple-300 h-[20vh] rounded-md p-4">
              <h1>TOTAL COST PRICE OF ALL PRODUCTS</h1>
              <p>600000 UG</p>
            </div>
            <div className="bg-purple-300 h-[20vh] rounded-md p-4">
              <h1>TOTAL Profit OF ALL PRODUCTS</h1>
              <p>500000 UG</p>
            </div>
        </div>
              </div>
